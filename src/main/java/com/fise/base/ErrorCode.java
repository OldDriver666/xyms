...
public enum ErrorCode {
	...
	ERROR_SEARCH_UNEXIST("资源不足",10047),
	ERROR_SENSITIVEWORDS_EXISTED("内容存在敏感词",10048),
	ERROR_ACCOUNT_ALREADY_EXISTED("该账户已存在",10049),
	ERROR_ACCOUNT_LOCK("账号被锁定", 10100),
	ERROR_SEND_IDENTITY_CODE("邮箱验证码发送失败",10049),
